...
wget -O gan_epoch231_checkpoint.pth.tar https://www.dropbox.com/s/xpx6n6jhl266dzm/gan_epoch231_checkpoint.pth.tar?dl=1
python3 gan_inference.py --output-file $2 --checkpoint gan_inference.py --output-file

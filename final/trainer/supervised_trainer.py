...
class SupervisedTrainer:
    ...
    def __load_file(self):
        self.train_dataset = Cifar10(self.args,
                                     mode='train',
        ...
        self.train_data_loader = DataLoader(dataset=self.train_dataset,
                                            ...
                                            shuffle=True)
        self.test_dataset = Cifar10(self.args,
                                    mode='test',
                                    transform=transforms.Compose([
                                        transforms.ToTensor()
                                    ]))
    ...
    def __save_checkpoint(self, epoch, current_loss):
        ...
        if not os.path.exists("checkpoints/supervised"):
            os.makedirs("checkpoints/supervised")

        filename = "checkpoints/supervised/epoch{}_checkpoint.pth.tar".format(epoch)
        best_filename = "checkpoints/supervised/best_checkpoint.pth.tar"
